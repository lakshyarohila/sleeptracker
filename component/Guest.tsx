...
const Guest = () => {
  return (
    <div className='font-sans bg-black text-white'>
      {/* Hero Section */}
      <div className='flex flex-col md:flex-row items-center justify-between p-3 md:p-16 bg-black pt-20'>
      ...
      <div className='py-16 px-8 black'>
      ...
      <div className='py-16 px-8 bg-black'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div className='black p-6 rounded-md shadow'>
